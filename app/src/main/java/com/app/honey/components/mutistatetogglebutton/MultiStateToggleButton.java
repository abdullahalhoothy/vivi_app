package com.app.honey.components.mutistatetogglebutton;
...
public class MultiStateToggleButton extends ToggleButton {
    ...
    public void setElements(@Nullable CharSequence[] texts, int[] imageResourceIds, boolean[] selected) {
        ...
        for (int i = 0; i < elementCount; i++) {
            ...
            if (i == 0) {
                ...
                if (elementCount == 1) {
                    button = (Button) inflater.inflate(R.layout.view_single_toggle_button, mainLayout, false);
                } else {
                    button = (Button) inflater.inflate(R.layout.view_left_toggle_button, mainLayout, false);
                }
            } else if (i == elementCount - 1) {
                button = (Button) inflater.inflate(R.layout.view_right_toggle_button, mainLayout, false);
            } else {
                button = (Button) inflater.inflate(R.layout.view_center_toggle_button, mainLayout, false);
            }
            ...
            int oneDp = context.getResources().getDimensionPixelSize(com.intuit.sdp.R.dimen._1sdp);

            if (i == elementCount - 1) {
                setMargins(button, oneDp, oneDp, oneDp, oneDp);
            } else {
                setMargins(button, oneDp, oneDp, 0, oneDp);
            }
    ...
    public void setElements(List<String> texts, boolean[] selected) {
        if (texts == null) {
    ...
    public void setButtonState(View button, boolean selected) {
        ...
        button.setBackgroundResource(selected ? R.color.red : R.color.white);
